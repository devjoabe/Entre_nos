...
function App() {
  ...
  // logica pra arrastar na tela pro lado e mudar de aba
  const [touchStart, setTouchStart] = useState(null)
  const [touchEnd, setTouchEnd] = useState(null)
  const minSwipeDistance = 50

  // FIX: a gente guarda a aba que tava ativa na hora que o botao bolinha (FAB) abriu
  ...
  // FIX: sempre que a pessoa muda de aba no celular, o botao bolinha tem que fechar
  useEffect(() => {
    setFabAberto(false)
    fabAbaRef.current = null

    // logica pra animacao de slide ir pra esquerda ou direita dependendo de onde ele tava
    ...
    // joga a tela la pra cima quando troca de aba
  ...
  const handleFabClick = () => {
    if (fabAberto) {
      // FIX: so aciona a acao de criar se o cara continuou na mesma aba 
      ...
      // FIX: anota a aba exata antes de abrir as opcoes
    ...
    <>
      ...
      {!isCreating && (
        <button
          ...
          title="Conversar sobre nossa historia"
        >
