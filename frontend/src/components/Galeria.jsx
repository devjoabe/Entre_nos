...
export default function Galeria({ createTrigger, onCreateModeChange }) {
    ...
    // FIX: a gente salva o instante exato que a galeria abriu
    // pra ignorar clique no botão '+' que possa ter vindo de outra aba sem querer
    ...
    // FIX: se o clique no botão '+' for mais novo que a abertura da tela, a gente abre a janela de escolher foto
    useEffect(() => {
    ...
    // vai buscar as fotos salvas la no banco de dados e avisa quando terminar
    ...
    // lida com o envio da foto quando a pessoa escolhe um arquivo no celular/pc
    const handleFileChange = async (e) => {
        ...
        try {
            ...
            await carregarFotos(); // recarrega a galeria inteira pra mostrar a foto nova
        } catch (error) {
